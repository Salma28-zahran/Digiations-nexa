...
import 'package:digiations_nexa/features/home_manager/presentation/views/tabs/management_body/views/projects_screen.dart';
...
import '../../features/home_manager/presentation/views/tabs/management_body/views/tasks_screen.dart';
    ...
    switch (settings.name) {
      case PageRouteName.position:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: Position()),
          settings: settings,
        );
      case PageRouteName.department:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: Department()),
          settings: settings,
        );
      ...
      case PageRouteName.mainEmployee:
        return MaterialPageRoute(
          builder: (context) => BackgroundScreen(child: MainEmployee()),
          settings: settings,
        );
      case PageRouteName.homeManager:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: HomeManger()),
          settings: settings,
        );
      case PageRouteName.verifyEmail:
        return MaterialPageRoute(
          builder: (context) =>
              const BackgroundScreen(child: VerifyEmailScreen()),
          settings: settings,
        );
      case PageRouteName.verifyCode:
        return MaterialPageRoute(
          builder: (context) =>
              const BackgroundScreen(child: VerifyCodeScreen()),
          settings: settings,
        );
      case PageRouteName.resetPassword:
        return MaterialPageRoute(
          builder: (context) =>
              const BackgroundScreen(child: ResetPasswordScreen()),
          settings: settings,
        );
      case PageRouteName.projects:
        return MaterialPageRoute(
          builder: (context) =>
              const BackgroundScreen(child: ProjectsScreen()),
          settings: settings,
        );
      case PageRouteName.tasks:
        return MaterialPageRoute(
          builder: (context) =>
              const BackgroundScreen(child: TasksScreenManagement()),
          settings: settings,
        );
